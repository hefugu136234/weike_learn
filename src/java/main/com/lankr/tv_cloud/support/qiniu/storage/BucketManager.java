...
import com.lankr.tv_cloud.support.qiniu.storage.model.FileListing;
import com.lankr.tv_cloud.support.qiniu.util.Auth;
import com.lankr.tv_cloud.support.qiniu.util.StringMap;
import com.lankr.tv_cloud.support.qiniu.util.StringUtils;
import com.lankr.tv_cloud.support.qiniu.util.UrlSafeBase64;
...
public final class BucketManager {
	...
	public static void main(String[] args) throws QiniuException {
		Auth auth = Auth.create("879DzN-b2m9LPSfp-oak1Es0K3bRAjo2c1edDozI",
				"9PWtmpYVCf124HxwefUls_i_ni-3GFXxiMtGQ7C9");
		BucketManager bucket = new BucketManager(auth);
		DefaultPutRet ret = bucket
				.fetch("http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=O2oJ3NTCBoKxZE3WXCCjsdDCVP7zUEkawT9OXHIoXuQCxo65bJnK8Wo0gdFduPFMT7j9kZ1ZeXVjR4STBK5zv9-KWN2MoevybtSKCcGWLc-k8Kc8_Pj65MxNc6cXzVhOIEDhADASON&media_id=5iPccnaGI6BONKmnatMM1_IfgzOdPlPBP729Jag1_OOrpvrOhiDHxEVbjHCKF4gB",
						"lankr");
