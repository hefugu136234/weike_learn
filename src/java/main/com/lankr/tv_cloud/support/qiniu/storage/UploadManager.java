...
import com.lankr.tv_cloud.support.qiniu.storage.persistent.FileRecorder;
 ...
 * 只要超过了{@link com.lankr.tv_cloud.qiniu.common.Config#PUT_THRESHOLD}
 */
...
//			File p = File.createTempFile(Tools.getUUID(), ".png", f);			
//			Tools.makeQr(p, "this is a test");			
//			FileRecorder recorder = new FileRecorder(f);			
//			UploadManager um = new UploadManager(recorder);
//			Response resp = um.put(p, p.getName(), "879DzN-b2m9LPSfp-oak1Es0K3bRAjo2c1edDozI:y6Dr2uFAvYGk9icqR520jeGoPw0=:eyJzY29wZSI6ImxhbmtyIiwiZGVhZGxpbmUiOjE0NjE4NDE1OTZ9");
