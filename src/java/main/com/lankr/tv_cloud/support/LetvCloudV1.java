...
public class LetvCloudV1 {
	 ...
	 * @throws Exception
	 */
	public String videoUploadInit(String video_name, String client_ip,
			int file_size) throws Exception {
	 ...
	 *            video_file 文件绝对路径
	 * @param string
	 *            upload_url 视频上传地址，视频上传时提交地址
	 * @return String
	 * @throws IOException
	 */
	public String videoUpload(String video_file, String upload_url)
			throws IOException {
	 ...
	 *            video_name 视频名称
	 * @param string
	 *            js_callback Javascript回调函数，视频上传完毕后调用
	 ...
	 * @throws Exception
	 */
	public String videoUploadFlash(String video_name, String js_callback,
			int flash_width, int flash_height, String client_ip)
			throws Exception {
	 ...
	 */
	public String videoUploadFlash(String video_name, String js_callback,
			int flash_width, int flash_height) throws Exception {
		return videoUploadFlash(video_name, js_callback, flash_width,
				flash_height, "");
	}
	 ...
	 */
	public String videoUploadFlash(String video_name, String js_callback,
			int flash_width) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String videoUpdate(int video_id, String video_name,
			String video_desc, String tag, int is_pay) throws Exception {
	 ...
	 */
	public String videoUpdate(int video_id, String video_name,
			String video_desc, String tag) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String videoUpdate(int video_id, String video_name, String video_desc)
			throws Exception {
	 ...
	 * @param const status
	 *        视频状态：ALL表示全部；PLAY_OK表示可以正常播放；FAILED表示处理失败；WAIT表示正在处理过程中。默认值为ALL
	 * @return String
	 * @throws Exception
	 */
	public String videoList(int index, int size, int status) throws Exception {
		...
		if (status == ALL || status == PLAY_OK || status == FAILED
				|| status == WAIT) {
	 ...
	 * 
	 * @param string
	 *            video_id_list 视频ID列表，使用符号-作为间隔符，每次最多操作50条记录
	 * @return String
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public String dataVideoHour(String date, int hour, int video_id, int index,
	 ...
	 * @throws Exception
	 */
	public String dataVideoHour(String date, int hour, int video_id)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public String dataVideoDate(String start_date, String end_date,
			int video_id, int index, int size) throws Exception {
	 ...
	 */
	public String dataVideoDate(String start_date, String end_date,
			int video_id, int index) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String dataVideoDate(String start_date, String end_date, int video_id)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public String dataTotalDate(String start_date, String end_date, int index,
			int size) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String dataTotalDate(String start_date, String end_date)
			throws Exception {
	 ...
	 * 
	 * @param string
	 *            uu 用户唯一标识码，由乐视网统一分配并提供
	 * @param string
	 *            vu 视频唯一标识码
	 * @param string
	 *            type
	 *            接口类型：url表示播放URL地址；js表示JavaScript代码；flash表示视频地址；html表示HTML代码
	 * @param string
	 *            pu 播放器唯一标识码
	...
	public String videoGetPlayinterface(String uu, String vu, String type,
			String pu, int auto_play, int width, int height) {
		HashMap<Object, Object> params = new HashMap<Object, Object>();
		params.put("uu", uu);
		params.put("vu", vu);
		if (pu.length() > 0) {
		...
		if (type == "js") {
			response = "<script type=\"text/javascript\">var letvcloud_player_conf = "
					+ jsonString
		...
		if (type == "html") {
			response = "<embed src=\"http://yuntv.letv.com/bcloud.swf\" allowFullScreen=\"true\" quality=\"high\" width=\""
					+ width
					+ "\" height=\""
					+ height
					+ "\" align=\"middle\" allowScriptAccess=\"always\" flashvars=\""
					+ queryString
	 ...
	 */
	public String videoGetPlayinterface(String uu, String vu, String type,
			String pu, int auto_play, int width) {
	...
	// 构造请求串
	public String makeRequest(String api, HashMap<Object, Object> params)
			throws Exception {
