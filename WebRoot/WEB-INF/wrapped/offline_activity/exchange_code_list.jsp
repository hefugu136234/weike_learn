...
<script type="text/javascript"
	src="/assets/js/admin/offline_activity/exchange_code_list.js"></script>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h5>
				<span style="color: green;">${name}</span>兑换码
			</h5>
				<button class="btn btn-sm btn-primary bfR mt20"
					id="new_exchange">生成兑换码</button>
		</div>
		<div class="ibox-content">

			<div id="list_wrapper" class="dataTables_wrapper">
				<table id="exchange_code_table" class="display dataTable dtr-inline"
					cellspacing="0" width="100%" role="grid" style="width: 100%;">

					<thead>
						<tr>
							<th rowspan="1" colspan="1" style="width: 20%;">兑换码</th>
							<th rowspan="1" colspan="1" style="width: 20%;">创建时间</th>
							<th rowspan="1" colspan="1" style="width: 20%;">兑换者</th>
							<th rowspan="1" colspan="1" style="width: 20%;">兑换时间</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="categoryModalLabel_pdf">生产兑换码：</h4>
			</div>
