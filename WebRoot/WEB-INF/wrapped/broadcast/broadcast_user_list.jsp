...
<script type="text/javascript"
	src="/assets/js/admin/broadcast/broadcast_user_list.js"></script>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h5><span style="color: green;">${requestScope.broadName}</span>直播报名人员</h5>
		</div>
		<div class="ibox-content">

			<div id="list_wrapper" class="dataTables_wrapper">
				<table id="broadcast_list_user_table" class="display dataTable dtr-inline"
