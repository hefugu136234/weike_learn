...
<script src="/assets/js/admin/collect/compilation/resource/mgr.js"></script>
<style>
<!--
.pre-view {
...
<div class="row wrapper border-bottom white-bg page-heading">
	...
	<div class="col-lg-2">
		<a class="btn btn-sm btn-primary bfR mt20"
			href="/project/collect/compilation/resource/list/page/${requestScope.compilation.uuid }">返回</a>
	</div>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content" style="display: block;">
			<form id="new_compilation_res_form" method="post" action=""
				class="form-horizontal">

				<input type="hidden" name="resourceGroupUuid" id="resourceGroupUuid"
					value="${requestScope.resourceGroup.uuid }">
				<input type="hidden" name="compilationUuid" id="compilationUuid"
				...
				<div class="form-group">
					<div class="col-sm-6 col-sm-offset-3">
						...
						<a href="/project/collect/compilation/resource/list/page/${requestScope.compilation.uuid }" class="btn btn-warning">取消</a>
					</div>
				</div>
				<div class="hr-line-dashed"></div>
			</form>
