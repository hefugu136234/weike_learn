...
<script src="/assets/js/admin/banner/banner_showTableData_all.js"></script>
	
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h5><font color = "red">全部 Banner</font></h5>
		</div>
		<div class="ibox-content">
			<div id="bannerList_all" class="dataTables_wrapper">
				<table id="bannerTable_all" class="display dataTable dtr-inline"
...
<!-- 信息完整显示模态框 -->
<div class="modal fade" id="dataModal_all" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="categoryModalLabel_all">该单元格完整信息如下：</h4>
			</div>
			<div class="modal-body">
				<div id="dataDetail_all" ></div>
			</div>
