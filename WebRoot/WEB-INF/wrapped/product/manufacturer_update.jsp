				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="name"
							...
							value="${requestScope.manufacturer.name}" placeholder="厂商名称(60字以内)"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="serialNum"
							required="required" maxlength="4" value="${requestScope.manufacturer.serialNum}" readonly="readonly"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea name="address" cols="60" rows="4" maxlength="180"
							placeholder="厂商地址(200字以内)">${requestScope.manufacturer.address}</textarea>
					</div>
				</div>
