...
<script type="text/javascript" src="/assets/js/web/comment/comment_common.js"></script>
...
<div class="panel no-radius">
	<div class="panel-body">
		<form class="form-horizontal comments-form mt32" id="comments_form">
			...
			<div class="form-group">
				<div class="col-sm-offset-1 col-sm-10">
					...
					<button type="button" class="btn btn-blue pull-right" id="add_comment_push">提交评论</button>
				</div>
			</div>
		</form>
		...
		<div class="text-center">
			<ul id="comment_pagination_ul" class="pagination"></ul>
		</div>
