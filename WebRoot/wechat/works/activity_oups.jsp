...
<html>
  <head>
    ...
    <title>${requestScope.activityName}</title>
      ...
      <div class="content">
        ...
        <div id="act_apply_form">
          ...
          <div class="default-form">
            <label class="form-group form-select">
              ...
              <div class="form-input">
                <select id="categroy_one" class="form-control">
          ...
          <div class="default-form mt10">
            ...
            <label class="form-group item-stacked-label">
              <div class="form-input">
          ...
          <div class="default-form">
            <div class="item item-checkbox protocol">
      ...
      <div class="content">
        ...
        <div class="act-apply-feedback">
          ...
          <div class="info white-bg">
            ...
            <p id="oupsName" class="label">《<span id="proName"></span>》</p>
          </div>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        $('#submitBtn').click(function(){
          var selected_category_uuid=$('#categroy_one').val();
