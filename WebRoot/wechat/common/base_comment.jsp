...
<script type="text/javascript" src="/assets/js/wechat/common/base_comment.js"></script>
...
<div class="resource-comments mt10">
  <div class="icon-title mb-1 white bold clearfix">
    ...
    <a href="javascript:;" class="button btn-cyan pull-right" id="sub_comments">发 送</a>
  </div>
...
<div class="feed-back-modal" id="comments_reply_modal">
  ...
  <div class="alert">
    ...
    <div class="btns">
      ...
      <div class="btn sub sub-reply">提交回复</div>
    </div>
  </div>
</div>
