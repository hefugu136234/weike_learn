...
<div class="page">
	<header class="top-bar video-top-bar">
		<div class="crumb-nav">${res_vo.name}</div>
	</header>
	...
	<div class="video-split-con clearfix">
		...
		<div class="video-ppt-container">
			<ul id="pdf_list_ul" class="ppt-list">
				<c:forEach var="item" items="${res_vo.threeScreen.pdfList}"
					varStatus="index">
					<li class="item${index.index==0?' active':''}"><img
						src="http://7xo6el.com2.z0.glb.qiniucdn.com/${res_vo.threeScreen.pdfTaskId}?odconv/jpg/page/${item}/density/150/quality/80/resize/800"
						height="280" alt=""></li>
				</c:forEach>
			</ul>
		</div>
